...
public class UMDMstatus {
	...
	private static Logger log = Logger.getLogger(UMDMstatus.class);
	...
	public void init(String strConfigFile) {
		...
		try {
			...
			// Stuff the Xpath hashmap with namespaces
	...
	private boolean fProcessUMDM(DigitalObject oDObj) {
		...
		try {
			...
			// Process Books, Images and Films
			if (oDObj != null && oDObj.isUMDMEditable()) {
	...
	public static void main(String[] args) {
		...
		try {
			...
			UMDMstatus oSweeper = new UMDMstatus();
