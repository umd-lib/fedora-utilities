...
//						"\n");
	...
	public void Process(String fileName) {
		...
		List<String> strTitles = new ArrayList<String>();
		METSxml oMETS;
		UMAMxml oUMAM;
...
//					}
					...
					if( ! ItIsInHere( strTitles, strTitle) ) {
						strTitles.add(strTitle);
						oListWriter.write(strTitle + "\n" );
					}
...
//					}
	...
	private boolean ItIsInHere( List<String> inList, String compVal ) {
		boolean foundIt = false;
		
		for (String strMember : inList) {
			// System.out.println("Comparing -" + strMember + "->" + compVal + "<");
			if( strMember.equals(compVal) ) {
				foundIt = true;
				break;
			}
		}
	...
	public static void main(String[] args) {
		...
		SweepAggregate thisSweep = new SweepAggregate();
