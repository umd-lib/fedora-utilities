...
/**
 * This is a UMAM Sweep.  It takes the list of Henson Pids (UMDM)
 ...
 * 
 */
public class SweepHensonShareStream {
  ...
  public void Process () {
    ...
    TabTextOut oOutFile = createReport();
     ...
     for( HashMap<String, String> hInRecord : tInFile ) {
       ...
       strUmamPid = hInRecord.get("umamPid");
          ...
          //for (String sPart : lParts) {
            ...
            if( amFOXML != null ) {
              ...
              if( dUMAM != null ) {
                ...
                System.out.println("UMAM Foxml coming up null?");
              }
...
//    }
  ...
  public static void main ( String[] args ) {
    ...
    SweepHensonShareStream thisSweep = new SweepHensonShareStream();
    thisSweep.Process();
