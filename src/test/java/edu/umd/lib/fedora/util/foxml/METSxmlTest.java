...
public class METSxmlTest extends TestCase {
	...
	public void testMETSfromFile() {
		...
		thisMETS = uf.getMETS(System.getProperty("user.dir") + File.separator
				...
				+ "resources" + File.separator + "edu" + File.separator + "umd"
				+ File.separator + "lib" + File.separator + "fedora"
				+ File.separator + "util" + File.separator + "foxml"
	...
	private boolean fPrintDoc(Document docThisDocument, String strFile) {
		...
		try {
			...
			if (bFileOut) {
				...
				// Set up the interminable number of structures for printing
				// this puppy
